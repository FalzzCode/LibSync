...
<section class="page form-page">
    ...
    <article class="detail-card borrowing-detail"><div class="detail-card__cover">@if($borrowing->book->cover_image)<img src="{{ asset('storage/'.$borrowing->book->cover_image) }}" alt="Cover {{ $borrowing->book->title }}">@else<span>Ruang<br>Baca</span>@endif</div>
