...
class BackupController extends Controller
{
    public function download(): StreamedResponse
    {
        ...
        return response()->streamDownload(function () {
            ...
            echo json_encode('note', $options).':'.json_encode('Snapshot data operasional. Password pengguna tidak disertakan demi keamanan.', $options).',';
            ...
            $this->writeCollection('members', Member::withTrashed()->cursor(), $firstCollection, $options);
